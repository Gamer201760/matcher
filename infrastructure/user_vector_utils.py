...
def create_user_vector(
    user: dict, parameters: list, caps: dict | None = None, apply_normalization=True
):
...
def create_group_vector_with_weights(
    values: dict, parameters: list, weights: dict, caps: dict | None = None
):
...
if __name__ == '__main__':
    ...
    group_a = {'rooms': 1, 'roommates': 1, 'budget': 10000, 'months': 12}
    group_b = {'rooms': 2, 'roommates': 2, 'budget': 15000, 'months': 6}
